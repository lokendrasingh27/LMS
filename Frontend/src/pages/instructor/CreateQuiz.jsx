      ...
      <div className="fixed inset-0 bg-white z-50 overflow-y-auto">
        <div className="bg-[#E3F1F1] min-h-screen font-sans p-4 sm:p-6 md:p-10">
          <div className="max-w-6xl mx-auto relative">
            ...
            {/* Submit */}
            <div className="mt-8">
              <button onClick={handleSubmitQuiz} disabled={isSubmitting} className=" py-4 px-6 bg-green-600 text-white font-bold text-lg rounded-lg shadow-md hover:bg-green-700 disabled:bg-green-400">
