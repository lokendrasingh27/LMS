  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 p-4">
        ...
        <button onClick={()=> Naviagte(user ?`/courses/${course._id}`:"/login")} className="mt-1 w-full rounded-xl border border-zinc-200 bg-[#006D77] py-2 text-xs font-medium text-white hover:bg-zinc-100"><a href="#courseviewpage ">View details</a></button>
      </div>
    </motion.div>
  );
}