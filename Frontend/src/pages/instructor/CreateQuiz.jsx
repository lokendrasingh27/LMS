                ...
                <div className="max-w-6xl mx-auto relative">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-lg mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label htmlFor="quizTitle" className="block text-sm font-medium text-slate-600 mb-1">Quiz Title</label>
                                <input type="text" id="quizTitle" value={quizTitle} onChange={(e) => setQuizTitle(e.target.value)} className="w-full px-4 py-2 bg-slate-100 border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                            </div>
                            <div>
                                <label htmlFor="dueDate" className="flex items-center text-sm font-medium text-slate-600 mb-1"><CalendarIcon /><span className="ml-2">Due Date</span></label>
                                <input type="date" id="dueDate" value={dueDate} onChange={(e) => setDueDate(e.target.value)} className="w-full px-4 py-2 bg-slate-100 border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                            </div>
                            <div>
                                <label htmlFor="timeLimit" className="flex items-center text-sm font-medium text-slate-600 mb-1"><ClockIcon /><span className="ml-2">Time Limit (Minutes)</span></label>
                                <input type="number" id="timeLimit" value={timeLimit} onChange={(e) => setTimeLimit(e.target.value)} className="w-full px-4 py-2 bg-slate-100 border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                        ...
                        {/* --- Left Side: Questions List (This column will scroll) --- */}
                        ...
                        {/* --- Right Side: Add New Question (This column will be sticky) --- */}
                        <div className="bg-white p-8 rounded-2xl shadow-lg lg:sticky lg:top-10">
                            ...
                            <div className="space-y-4">
                                <textarea value={newQuestionText} onChange={(e) => setNewQuestionText(e.target.value)} placeholder="Type your question here..." className="w-full p-4 bg-slate-100 border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" rows="3"></textarea>
                                <select value={newQuestionType} onChange={(e) => setNewQuestionType(e.target.value)} className="w-full p-3 bg-slate-100 border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                ...
                                <div className="pt-2">
                                    ...
                                    <select value={newCorrectAnswer} onChange={(e) => setNewCorrectAnswer(e.target.value)} className="w-full p-3 bg-slate-100 border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                ...
                                <button onClick={addQuestion} className="w-full mt-4 py-3 px-4 bg-[#001F3F] text-white font-semibold rounded-lg hover:bg-[#006D77] transition">Add Question to List</button>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* --- Final Submit Button --- */}
                    <div className="mt-8">
                        <button onClick={handleSubmitQuiz} disabled={isSubmitting} className="w-full py-4 px-6 bg-green-600 text-white font-bold text-lg rounded-lg shadow-md hover:bg-green-700 disabled:bg-green-400 transition">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
                    <div className="bg-white p-8 rounded-2xl shadow-2xl text-center max-w-sm mx-auto">
                        ...
                        <button
                            ...
                            className="w-full px-6 py-3 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-300"
                        >
                            OK
                        </button>
                    </div>
