          ...
          <section>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600">
                <li>Average Course Completion Rate: <strong>72%</strong></li>
                <li>Average Student Engagement Time: <strong>4.5 hours/week</strong></li>
                <li>Top Performing Course: <strong>React for Beginners</strong></li>
                <li>Most Enrolled Course: <strong>Advanced JavaScript</strong></li>
              </ul>
            </div>
          </section>
