...
const CourseDetails = ({ course }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
      ...
      <p className="mb-2">
        <strong>Instructor:</strong> {details.creator?.name || details.instructor || 'N/A'}
      </p>
      <p className="mb-2">
        <strong>Created At:</strong> {details.createdAt ? new Date(details.createdAt).toLocaleDateString() : 'N/A'}
      </p>
      <p className="mb-2">
        <strong>Last Updated:</strong> {details.updatedAt ? new Date(details.updatedAt).toLocaleDateString() : 'N/A'}
      </p>
