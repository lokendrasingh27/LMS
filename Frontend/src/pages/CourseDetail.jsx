...
const CourseDetails = () => {
  ...
  useEffect(() => {
    ...
    getCourseLecture();
    // Add courseId as a dependency to refetch when the course changes.
  }, [courseId]);
  ...
  return (
    // FIX: The main container is now a simple flex container that takes up the screen height.
    // We removed lg:w-[100vw] and the top-level overflow-y-auto.
    <div className="flex bg-gray-100 h-screen">
      <Sidebar />
      {/* FIX: Added 'flex-1' to this Card. This tells it to grow and take up all available space. */}
      {/* The 'overflow-y-auto' is correctly placed here so only the content scrolls, not the sidebar. */}
      <Card className="flex-1 max-w-7xl overflow-y-auto rounded-md mx-auto bg-[url('/bgimage.png')] shadow-md pt-5 ">
        {/* Header section */}
        <div className="px-4 py-2 z-9 shadow-xl">
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-4">
              {!isEnrolled ? (
                <Button
                  onClick={() => handlePayment(user._id, courseId)}
        ...
        <div className="p-6 mt-10">
          <div className="flex flex-col lg:flex-row lg:space-x-8">
            ...
            <div>
              ...
              <p
                className="mb-4 text-gray-700 whitespace-normal "
              ...
              <Card>
                <CardContent className="p-4 flex flex-col">
                  <div className="w-full aspect-video mb-4">
                    {selectedLecture?.videoUrl || selectedLecture?.videoLink ? (
                      <video
